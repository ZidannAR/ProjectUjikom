...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Tambah Lokasi Kantor</h1>
    ...
    <div class="card-body">
        <form action="{{ route('admin.office-locations.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Contoh: Kantor Pusat Jakarta" required>
                @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>

            <div class="form-group">
                <label for="radius_meter">Radius (meter) <span class="text-danger">*</span></label>
                <input type="number" name="radius_meter" id="radius_meter" class="form-control @error('radius_meter') is-invalid @enderror" value="{{ old('radius_meter', 100) }}" min="1" required>
            ...
            <!-- Peta Leaflet -->
            <div class="form-group">
                <label><i class="fas fa-map-marked-alt text-primary"></i> Pilih Lokasi di Peta <span class="text-danger">*</span></label>
                <small class="form-text text-muted mb-2 d-block">Klik pada peta, drag marker, atau gunakan kotak pencarian di peta untuk menentukan koordinat.</small>
                <div id="map"></div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="latitude" id="latitude" class="form-control @error('latitude') is-invalid @enderror" value="{{ old('latitude') }}" placeholder="Contoh: -6.200000" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="longitude" id="longitude" class="form-control @error('longitude') is-invalid @enderror" value="{{ old('longitude') }}" placeholder="Contoh: 106.816666" required>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const defaultLng = {{ old('longitude') ?: '118' }};
    const defaultZoom = {{ old('latitude') ? '15' : '5' }};
    ...
    // Klik peta → pasang/pindahkan marker
    ...
    // Jika old values ada, tampilkan marker
